// lib/main.dart
import 'package:landslide_risk_reporter/pages/login_page.dart';
import 'package:landslide_risk_reporter/theme/app_theme.dart';
import 'package:landslide_risk_reporter/config/app_routes.dart';
import 'package:landslide_risk_reporter/pages/home_page.dart';
import 'package:landslide_risk_reporter/pages/official_profile_page.dart';
import 'package:landslide_risk_reporter/pages/report_form_page.dart';
import 'package:landslide_risk_reporter/pages/view_reports_page.dart';
import 'package:landslide_risk_reporter/pages/view_reports_page_admin.dart';
import 'package:landslide_risk_reporter/pages/report_detail_page.dart';
import 'package:landslide_risk_reporter/pages/report_detail_page_admin.dart';
import 'package:landslide_risk_reporter/pages/report_feedback_page.dart';
import 'package:landslide_risk_reporter/pages/risk_factor_page.dart';
import 'package:landslide_risk_reporter/pages/submit_report_page.dart';
